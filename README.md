...
A lightweight convolutional neural network takes a low resolution thermal image and an RGB derived edge map as input and produces an enhanced thermal image that preserves true thermal characteristics while improving spatial clarity. This design improves thermal image quality, reduces reliance on expensive sensors, and maintains safety through strict separation of sensing modalities.
